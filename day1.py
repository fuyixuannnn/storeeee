...
日销量=((10+60+43+63+63+120+72+69+35+140+90+24+45+25+60+129+10+43+63+60+63+60+58+140+48+43+57+10+63+78)/30)
T恤=(100*(63+45+129+63+58+48+63)/1844)
衬衫=(100*120/1844)
风衣=(100*(43+25+43+60+43+78)/1844)
牛仔裤=(100*(60+72+35+90+60+60+140)/1844)
皮草=(100*(64+24+63+57)/1844)
羽绒服=(100*(10+69+140+10+10)/1844)
print("总销售额=",round(total,2))
print("日平均销量=",日销量)
print("T恤销售量占总销售量的",round(T恤,2),"%")
print("衬衫销售量占总销售量的",round(衬衫,2),"%")
print("风衣销售量占总销售量的",round(风衣,2),"%")
print("牛仔裤销售量占总销售量的",round(牛仔裤,2),"%")
print("皮草销售量占总销售量的",round(皮草,2),"%")
print("羽绒服销售量占总销售量的",round(羽绒服,2),"%")